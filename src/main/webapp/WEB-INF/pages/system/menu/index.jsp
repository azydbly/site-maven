...
<div class="page-container wrapper wrapper-content animated fadeInUp">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a href="javascript:;" onclick="delAll(getDTSelect(), '/xst/menu/delete', reloadTable)" class="btn btn-danger radius">
                <i class="Hui-iconfont">&#xe6e2;</i> 批量删除
            </a>
            <a href="javascript:;" onclick="add('添加菜单','/xst/menu/add','1','360','no')" class="btn btn-primary radius">
