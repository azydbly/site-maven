 ...
 */
// 复杂表头导出excel 参考至http://blog.csdn.net/shfscut/article/details/77505487
(function( factory ){
...
//              }
        ...
        if (mgCnt > 0){
         ...
         var z = _createNode(rels, "mergeCells", {
          ...
          for(i=0;i<mgCnt;i++){
           var n = _createNode(rels, "mergeCell", {
                    attr: {
                      ref: merges[i]
                    }
                  });
...
//		}
		...
		if(config.header){ /*CHANGE*/
            for(var i = 0; i < data.header.length; i++)
            	rows.push($.map(data.header[i], function(a) {
                return {
